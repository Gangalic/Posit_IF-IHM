 ...
 * @author cgangalic
 */
public class ProfilConsultationAction extends Action{
    ...
    public void execute(HttpServletRequest request) {
        ...
        try{
            ...
            c = Service.trouverClientEnAttente(e);
        } catch (Exception ex) {
            Logger.getLogger(ProfilConsultationAction.class.getName()).log(Level.SEVERE, null, ex);
        }
